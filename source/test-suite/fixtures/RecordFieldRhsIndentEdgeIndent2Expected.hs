...
firstAndLater argument =
  Settings
    { firstField  =
        transformFirstValue argument additionalArgument
    , secondField =
        transformSecondValue argument additionalArgument
    }
...
updated settings inputValue =
  settings
    { updateField   =
        case inputValue of
          FirstInput firstValue -> transformFirstInput
            firstValue
            additionalArgument
          SecondInput secondValue -> transformSecondInput
            secondValue
            additionalArgument
  ...
  Container
    { runAction =
        do
          ...
          secondResult <- runSecondAction secondInput
...
listed firstValue secondValue =
  Container
    { values =
        [ transformFirstValue firstValue additionalArgument
