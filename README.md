<p align="center">
  <picture>
    ...
    <img src="doc/assets/logo-light.svg" alt="brittany" width="148" />
  </picture>
</p>
...
- The test suite verifies all 547 golden fixtures and 285 focused regression,
  compatibility, and fallback cases. The current result is 832 passing and 0
  pending tests.
...
- GHC 9.14 language support is tracked in the machine-checked
